...
import 'package:sps_persian_datetime_picker/src/date/shamsi_date.dart';
    ...
    switch (_mode) {
      case PDatePickerMode.day:
        return _MonthPicker(
          ...
          currentDate: Jalali.now(initDateTime: widget.myCurrentDate),
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          mode: _mode,
          title: formatMonthYearSp(_currentDisplayedMonthDate!),
          onTitlePressed: () {
